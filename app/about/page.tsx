...
const CONTACT_LINKS = [
  {
    name: "Email",
    content: "hammadpvt.2@gmail",
    href: "mailto:hammadpvt.2@gmail.com",
    icon: <FaEnvelope height={"50px"} />,
  },
  {
    name: "Telegram",
    href: "https://t.me/H4MMXD",
    content: "@H4MMXD",
    icon: <SiTelegram height={"50px"} />,
  },
  {
    name: "GitHub",
    href: "https://github.com/Hammad-og",
    content: "/Hammad-og",
          ...
          >
            <div className="flex flex-row lg:flex-col items-center">
              ...
              <div className="flex flex-col gap-3 lg:items-center ml-10 md:ml-20 lg:ml-0">
                <p className="text-center text-xl">Mohammad Hammad</p>
        ...
        <main className="basis-3/4 w-[500px]">
          ...
          >
            ...
            <p className="mb-10 text-roboto">
              Hey there! I&apos;m Mohammad, aka EREN — a frontend developer
              from New Delhi building clean, animated interfaces that refuse
              to be boring. Web apps, UI experiments, whatever needed to
              exist — I shipped it.
            </p>
            <p className="mb-10">
              When I&apos;m not coding, you can find me exploring new
              technologies, sketching UI ideas in Figma, or figuring out how
              to make the next project feel a little less ordinary.
            </p>
